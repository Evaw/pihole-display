...
print({cs_pin: cs_pin, dc_pin: dc_pin})
...
class ShowState:
    ...
    def toMap(self):
        return {
            "showA": self.showA,
            "showB": self.showB,
            "showACount": self.showACount,
            "showBCount": self.showBCount
        }
showState = ShowState()
ITERATIONS = 20
...
while True:
    ...
    if not buttonA.value:
        ...
        showState.showB = False
        showState.showACount = 0
        showState.showB = 0
        backlight.value = False
    if not buttonB.value:
        showState.showA = False
        showState.showB = True
        showState.showACount = 0
        showState.showBCount = 0
        backlight.value = False

    if showState.showA and showState.showACount > ITERATIONS:
        showState.showA = False
        showState.showACount = 0
        clearCanvas()
        pushToScreen()
    ...
    if showState.showB and showState.showBCount > ITERATIONS:
        showState.showB = False
        showState.showBCount = 0
        clearCanvas()
        pushToScreen()
    ...
    if showState.showB:
        ...
        draw.text((x, y), "DNS Qs: {}".format(str(DNSQUERIES)), font=font, fill="#FF00FF")
